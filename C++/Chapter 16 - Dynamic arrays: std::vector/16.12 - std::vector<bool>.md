...
#include <iostream> #include <vector> int main() { std::vector<bool> v { true, false, false, true, true }; for (int i : v) std::cout << i << ' '; std::cout << '\n'; // Change the Boolean value with index 4 to false v[4] = false; for (int i : v) std::cout << i << ' '; std::cout << '\n'; return 0; }
...
[this article](https://isocpp.org/blog/2012/11/on-vectorbool)
this article
...
template<typename T> void foo( std::vector<T>& v ) { T& first = v[0]; // get a reference to the first element // Do something with first }
...
`std::vector<bool>`
.
[Next lesson 16.xChapter 16 summary and quiz](https://www.learncpp.com/cpp-tutorial/chapter-16-summary-and-quiz/)
Next lesson
16.x
Chapter 16 summary and quiz
[Back to table of contents](/)
[Previous lesson 16.11std::vector and stack behavior](https://www.learncpp.com/cpp-tutorial/stdvector-and-stack-behavior/)
Previous lesson
16.11

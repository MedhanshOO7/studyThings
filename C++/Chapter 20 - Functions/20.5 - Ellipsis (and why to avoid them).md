...
In C++17, fold expressions were added, which significantly improves the usability of parameter packs, to the point where they are now a viable option.We hope to introduce lessons on these topics in a future site update.
...
We hope to introduce lessons on these topics in a future site update.
[Next lesson20.6Introduction to lambdas (anonymous functions)](https://www.learncpp.com/cpp-tutorial/introduction-to-lambdas-anonymous-functions/)
Next lesson
20.6
Introduction to lambdas (anonymous functions)
[Back to table of contents](/)
[Previous lesson20.4Command line arguments](https://www.learncpp.com/cpp-tutorial/command-line-arguments/)
Previous lesson
20.4

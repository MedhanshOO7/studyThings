...
#include <string> #include <string_view> class Course { private: std::string m_name{}; const Course* m_prerequisite{}; public: Course(std::string_view name, const Course* prerequisite = nullptr): m_name{ name }, m_prerequisite{ prerequisite } { } };
...
Has-a
Uses-a
[Next lesson 23.5Dependencies](https://www.learncpp.com/cpp-tutorial/dependencies/)
Next lesson
23.5
Dependencies
[Back to table of contents](/)
[Previous lesson 23.3Aggregation](https://www.learncpp.com/cpp-tutorial/aggregation/)
Previous lesson
23.3
Aggregation
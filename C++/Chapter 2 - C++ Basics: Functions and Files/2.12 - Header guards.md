...
Author’s noteIn upcoming examples, we’ll define some functions inside header files. You generally shouldn’t do this.We are doing so here because it is the most effective way to demonstrate some concepts using functionality we’ve already covered.
...
#ifndef WAVE_H #define WAVE_H #include "square.h" #endif
...
WarningThe #pragma directive was designed for compiler implementers to use for whatever purposes they desire. As such, which pragmas are supported and what meaning those pragmas have is completely implementation-specific. With the exception of #pragma once, do not expect a pragma that works on one compiler to be supported by another.

Quiz time
Question #1Add header guards to this header file:add.h:int add(int x, int y);Show Solution#ifndef ADD_H #define ADD_H int add(int x, int y); #endif
...
int add(int x, int y);
Show Solution#ifndef ADD_H #define ADD_H int add(int x, int y); #endif
...
[Next lesson2.13How to design your first programs](https://www.learncpp.com/cpp-tutorial/how-to-design-your-first-programs/)
Next lesson
2.13
How to design your first programs
[Back to table of contents](/)
[Previous lesson2.11Header files](https://www.learncpp.com/cpp-tutorial/header-files/)
Previous lesson
2.11
Header files
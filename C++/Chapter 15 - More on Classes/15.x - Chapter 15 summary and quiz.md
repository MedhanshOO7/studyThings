...
int main() { Monster skeleton{ Monster::skeleton, "Bones", "*rattle*", 4 }; return 0; }
...
#include <string> #include <string_view> class Monster { public: enum Type { dragon, goblin, ogre, orc, skeleton, troll, vampire, zombie, maxMonsterTypes, }; private: Type m_type{}; std::string m_name{"???"}; std::string m_roar{"???"}; int m_hitPoints{}; public: Monster(Type type, std::string_view name, std::string_view roar, int hitPoints) : m_type{ type }, m_name{ name }, m_roar{ roar }, m_hitPoints{ hitPoints } { } }; int main() { Monster skeleton{ Monster::skeleton, "Bones", "*rattle*", 4 }; return 0; }
...
int main() { Monster skeleton{ Monster::skeleton, "Bones", "*rattle*", 4 }; skeleton.print(); Monster vampire{ Monster::vampire, "Nibblez", "*hiss*", 0 }; vampire.print(); return 0; }
and print:
...
int main() { Monster m{ MonsterGenerator::generate() }; m.print(); return 0; }
and print:
...
#include "Random.h" int main() { Monster m{ MonsterGenerator::generate() }; m.print(); return 0; }
...
[Next lesson 16.1Introduction to containers and arrays](https://www.learncpp.com/cpp-tutorial/introduction-to-containers-and-arrays/)
Next lesson
16.1
Introduction to containers and arrays
[Back to table of contents](/)
[Previous lesson 15.10Ref qualifiers](https://www.learncpp.com/cpp-tutorial/ref-qualifiers/)
Previous lesson
15.10
Ref qualifiers
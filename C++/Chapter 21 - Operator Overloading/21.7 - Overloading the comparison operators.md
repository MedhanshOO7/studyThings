...
In lesson 6.7 -- Relational operators and floating point comparisons, we discussed the six comparison operators. Overloading these comparison operators is comparatively simple (see what I did there?), as they follow the same patterns as we’ve seen in overloading other operators.
...
[Next lesson 21.8Overloading the increment and decrement operators](https://www.learncpp.com/cpp-tutorial/overloading-the-increment-and-decrement-operators/)
Next lesson
21.8
Overloading the increment and decrement operators
[Back to table of contents](/)
[Previous lesson 21.6Overloading unary operators +, -, and !](https://www.learncpp.com/cpp-tutorial/overloading-unary-operators/)
Previous lesson
21.6

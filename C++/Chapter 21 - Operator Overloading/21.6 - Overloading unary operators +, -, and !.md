...
Note that we’re returning a copy by value rather than a const reference here. This is because users of this function will probably expect the returned object to be modifiable.
[Next lesson 21.7Overloading the comparison operators](https://www.learncpp.com/cpp-tutorial/overloading-the-comparison-operators/)
Next lesson
21.7
Overloading the comparison operators
[Back to table of contents](/)
[Previous lesson 21.5Overloading operators using member functions](https://www.learncpp.com/cpp-tutorial/overloading-operators-using-member-functions/)
Previous lesson
21.5

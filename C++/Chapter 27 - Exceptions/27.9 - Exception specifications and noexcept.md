...
int doSomething() throw(); // does not throw exceptions int doSomething() throw(std::out_of_range, int*); // may throw either std::out_of_range or a pointer to an integer int doSomething() throw(...); // may throw anything
...
[this paper](http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2015/p0003r0.html#2.0)
this paper
for more context.
[Next lesson 27.10std::move_if_noexcept](https://www.learncpp.com/cpp-tutorial/stdmove_if_noexcept/)
Next lesson
27.10
std::move_if_noexcept
[Back to table of contents](/)
[Previous lesson 27.8Exception dangers and downsides](https://www.learncpp.com/cpp-tutorial/exception-dangers-and-downsides/)
Previous lesson
27.8

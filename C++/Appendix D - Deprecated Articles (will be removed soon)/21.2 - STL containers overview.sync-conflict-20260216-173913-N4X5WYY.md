...
We’ll talk more about both linked lists and iterators in future lessons.Although the STL string (and wstring) class aren’t generally included as a type of sequence container, they essentially are, as they can be thought of as a vector with data elements of type char (or wchar).
...
[Next lesson21.3STL iterators overview](https://www.learncpp.com/cpp-tutorial/stl-iterators-overview/)
Next lesson
21.3
STL iterators overview
[Back to table of contents](/)
[Previous lesson21.1The Standard Library](https://www.learncpp.com/cpp-tutorial/the-standard-library/)
Previous lesson
21.1

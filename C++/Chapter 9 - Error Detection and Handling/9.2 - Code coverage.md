9.2 — Code coverage
In the previous lesson 9.1 -- Introduction to testing your code, we discussed how to write and preserve simple tests. In this lesson, we’ll talk about what kind of tests are useful to write to ensure your code is correct.
...
int foo(int x, int y) { int z{ y }; if (x > y) { z = x; } return z; }
...
bool isLowerVowel(char c) { switch (c) // statement 1 { case 'a': case 'e': case 'i': case 'o': case 'u': return true; // statement 2 default: return false; // statement 3 } }
...
.
[Next lesson 9.3Common semantic errors in C++](https://www.learncpp.com/cpp-tutorial/common-semantic-errors-in-c/)
Next lesson
9.3
Common semantic errors in C++
[Back to table of contents](/)
[Previous lesson 9.1Introduction to testing your code](https://www.learncpp.com/cpp-tutorial/introduction-to-testing-your-code/)
Previous lesson
9.1

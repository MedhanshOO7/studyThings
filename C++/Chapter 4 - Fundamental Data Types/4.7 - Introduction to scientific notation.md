...
**Scientific notation**
is a useful shorthand for writing lengthy numbers in a concise manner. And although scientific notation may seem foreign at first, understanding scientific notation will help you understand how floating point numbers work, and more importantly, what their limitations are.
...
x 10
*exponent*
. For example, in the scientific notation
`1.2 x 10⁴`
,
`1.2`
is the significand and
`4`
is the exponent. Since 10⁴ evaluates to 10,000, 1.2 x 10⁴ evaluates to 12,000.
...
. That’s a really large number (too big to fit even in an 8 byte integer). It’s also hard to read (is that 19 or 20 zeros?). Even with separators (5,972,200,000,000,000,000,000,000) the number is still hard to read.
...
`5.9722 x 10²⁴ kg`
, which is much easier to read. Scientific notation has the added benefit of making it easier to compare the magnitude of two extremely large or small numbers simply by comparing the exponent.
...
Because it can be hard to type or display exponents in C++, we use the letter ‘e’ (or sometimes ‘E’) to represent the “times 10 to the power of” part of the equation. For example,
`1.2 x 10⁴`
would be written as
`1.2e4`
, and
...
`5 * 10⁻²`
is missing the negative sign, you may need to install a font that can display these characters. See
[this reddit thread for more info](https://www.reddit.com/r/archlinux/comments/1af46vq/some_unicode_characters_not_rendering_properly/)
this reddit thread for more info
.
Significant digits
...
`3.14`
. The other tells you the value of pi is
`3.14159`
. Both of these values are “correct”, but the latter is far more precise.
...
as
`3.14e0`
. Since there are 3 numbers in the significand, this number has 3 significant digits.
3.14159 would be written as 3.14159e0. Since there are 6 numbers in the significand, this number has 6 significant digits.

`3.14159`
would be written as
`3.14159e0`
. Since there are 6 numbers in the significand, this number has 6 significant digits.
...
`123`
), it is implicitly on the right end (e.g.
`123.`
)
Slide the decimal point left or right so there is only one non-zero digit to the left of the decimal.
...
[Next lesson 4.8Floating point numbers](https://www.learncpp.com/cpp-tutorial/floating-point-numbers/)
Next lesson
4.8
Floating point numbers
[Back to table of contents](/)
[Previous lesson 4.6Fixed-width integers and size_t](https://www.learncpp.com/cpp-tutorial/fixed-width-integers-and-size-t/)
Previous lesson
4.6

...
See the tutorial
[A1 -- Static and dynamic libraries](https://www.learncpp.com/cpp-tutorial/a1-static-and-dynamic-libraries/)
A1 -- Static and dynamic libraries
for more information on step 7.
...
vcpkg is a Microsoft-developed package manager that makes it easier to download, install, manage, and use C++ libraries. It integrates with Visual Studio. See
[this page](https://learn.microsoft.com/en-us/vcpkg/get_started/get-started-msbuild?pivots=shell-cmd)
this page
for more information on how to install and use vcpkg.
[Next lesson A.3Using libraries with Code::Blocks](https://www.learncpp.com/cpp-tutorial/a3-using-libraries-with-codeblocks/)
Next lesson
A.3
Using libraries with Code::Blocks
[Back to table of contents](/)
[Previous lesson A.1Static and dynamic libraries](https://www.learncpp.com/cpp-tutorial/a1-static-and-dynamic-libraries/)
Previous lesson
A.1
Static and dynamic libraries
...
int nValue{ 5 }; printValue(&nValue, Type::tCString);
...
Thus, a void pointer refers to the type of the pointer, whereas a null pointer refers to the value (address) of the pointer.
[Next lesson 20.1Function Pointers](https://www.learncpp.com/cpp-tutorial/function-pointers/)
Next lesson
20.1
Function Pointers
[Back to table of contents](/)
[Previous lesson 19.4Pointers to pointers and dynamic multidimensional arrays](https://www.learncpp.com/cpp-tutorial/pointers-to-pointers/)
Previous lesson
19.4

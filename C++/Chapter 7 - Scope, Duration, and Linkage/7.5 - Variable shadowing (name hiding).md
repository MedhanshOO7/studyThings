...
For gcc usersGCC and Clang support the flag -Wshadow that will generate warnings if a variable is shadowed. There are several subvariants of this flag (-Wshadow=global, -Wshadow=local, and -Wshadow=compatible-local. Consult the GCC documentation for an explanation of the differences.Visual Studio has such warnings enabled by default.
...
Visual Studio has such warnings enabled by default.
[Next lesson7.6Internal linkage](https://www.learncpp.com/cpp-tutorial/internal-linkage/)
Next lesson
7.6
Internal linkage
[Back to table of contents](/)
[Previous lesson7.4Introduction to global variables](https://www.learncpp.com/cpp-tutorial/introduction-to-global-variables/)
Previous lesson
7.4

...
`no linkage`
.
Global variables and function identifiers can have either internal linkage or external linkage. We’ll cover the internal linkage case in this lesson, and the external linkage case in lesson 7.7 -- External linkage and variable forward declarations.
...
// This function is declared as static, and can now be used only within this file // Attempts to access it from another file via a function forward declaration will fail [[maybe_unused]] static int add(int x, int y) { return x + y; }
main.cpp:
...
We cover unnamed namespaces in lesson 7.14 -- Unnamed and inline namespaces.
...
.
[Next lesson 7.7External linkage and variable forward declarations](https://www.learncpp.com/cpp-tutorial/external-linkage-and-variable-forward-declarations/)
Next lesson
7.7
External linkage and variable forward declarations
[Back to table of contents](/)
[Previous lesson 7.5Variable shadowing (name hiding)](https://www.learncpp.com/cpp-tutorial/variable-shadowing-name-hiding/)
Previous lesson
7.5

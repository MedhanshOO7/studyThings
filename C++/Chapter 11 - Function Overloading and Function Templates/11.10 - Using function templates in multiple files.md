...
#include <iostream> template <typename T> T addOne(T x); // function template forward declaration int main() { std::cout << addOne(1) << '\n'; std::cout << addOne(2.3) << '\n'; return 0; }
...
template <typename T> T addOne(T x) // function template definition { return x + 1; }
...
#ifndef ADD_H #define ADD_H template <typename T> T addOne(T x) // function template definition { return x + 1; } #endif
...
#include "add.h" // import the function template definition #include <iostream> int main() { std::cout << addOne(1) << '\n'; std::cout << addOne(2.3) << '\n'; return 0; }
...
#ifndef MAX_H #define MAX_H template <typename T> T max(T x, T y) { return (x < y) ? y : x; } #endif
...
#include "max.h" // import template definition for max<T>(T, T) #include <iostream> void foo(); // forward declaration for function foo int main() { std::cout << max(3, 5) << '\n'; foo(); return 0; }
...
Templates that are needed in multiple files should be defined in a header file, and then #included wherever needed. This allows the compiler to see the full template definition and instantiate the template when needed.
[Next lesson 11.xChapter 11 summary and quiz](https://www.learncpp.com/cpp-tutorial/chapter-11-summary-and-quiz/)
Next lesson
11.x
Chapter 11 summary and quiz
[Back to table of contents](/)
[Previous lesson 11.9Non-type template parameters](https://www.learncpp.com/cpp-tutorial/non-type-template-parameters/)
Previous lesson
11.9

...
#include <iostream> int main() { Timer t; // Code to time goes here std::cout << "Time elapsed: " << t.elapsed() << " seconds\n"; return 0; }
...
However, if the results of the first variant are no longer consistent with your initial measurements for that variant, then something has happened on the machine that is now affecting performance, and it will be hard to tell whether differences in measurement are due to the variant or due to the machine itself. In this case, it’s best to discard the existing results and re-measure.
[Next lesson 19.1Dynamic memory allocation with new and delete](https://www.learncpp.com/cpp-tutorial/dynamic-memory-allocation-with-new-and-delete/)
Next lesson
19.1
Dynamic memory allocation with new and delete
[Back to table of contents](/)
[Previous lesson 18.3Introduction to standard library algorithms](https://www.learncpp.com/cpp-tutorial/introduction-to-standard-library-algorithms/)
Previous lesson
18.3

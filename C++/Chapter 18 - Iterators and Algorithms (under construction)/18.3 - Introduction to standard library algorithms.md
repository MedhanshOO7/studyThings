...
std::sort(arr.begin(), arr.end(), std::greater{}); // use the standard library greater comparison // Before C++17, we had to specify the element type when we create std::greater std::sort(arr.begin(), arr.end(), std::greater<int>{}); // use the standard library greater comparison
...
[This video](https://www.youtube.com/watch?v=2olsGf6JIkU)
This video
...
Favor using functions from the algorithms library over writing your own functionality to do the same thing.
[Next lesson 18.4Timing your code](https://www.learncpp.com/cpp-tutorial/timing-your-code/)
Next lesson
18.4
Timing your code
[Back to table of contents](/)
[Previous lesson 18.2Introduction to iterators](https://www.learncpp.com/cpp-tutorial/introduction-to-iterators/)
Previous lesson
18.2
